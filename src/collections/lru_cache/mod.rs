// Disclaimer: code in this module was copied from https://github.com/contain-rs/lru-cache
// which was licensed under MIT/Apache-2.0 licenses. The code was copied and further modified
// due to lack of maintenance in the original project.
...
//! [https://github.com/contain-rs/lru-cache](https://github.com/contain-rs/lru-cache)**
//!
//! # Examples
//!
//! ```
...
/// ```
#[derive(Clone)]
pub struct IntoIter<K, V>(super::linked_hash_map::IntoIter<K, V>);
...
pub struct Iter<'a, K: 'a, V: 'a>(super::linked_hash_map::Iter<'a, K, V>);
...
///
/// Accessing a cache through the iterator does _not_ affect the cache's LRU state.
pub struct IterMut<'a, K: 'a, V: 'a>(super::linked_hash_map::IterMut<'a, K, V>);
